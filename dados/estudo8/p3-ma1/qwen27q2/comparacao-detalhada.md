...
|---|---|---|---|---|
| Calvo-Vecino et al. (REF33) | morbidade=18 (8.6%); morbidade=35 (16.6%) | RR 0.519 [0.303, 0.888] (a=18/224, c=35/226) | RR 0.519 [0.304, 0.887] | reproduz |
...
**Pool (ours)**: MH {"rr": 0.874, "ic95": [0.758, 1.008]} · DL {"rr": 0.787, "ic95": [0.58, 1.068], "tau2": 0.066, "i2": 73.9} — comparison under DL (erratum-15: DL numbers, MH caption). **Published: RR 0.778 [0.567, 1.068] → differs (decompose in the rows above)**.
