...
7. **Study 6 pre-registered (2026-08-31) — MA-1 measured same day** ([protocol](../estudo6/protocolo-estudo6.md) · [record](../estudo6/avaliacao-estudo6.md)): both published MA-1 pools **reproduced** from fresh reading (morbidity RR 0.778 ≡ 0.778; mortality 1.023 vs 1.021); zero unexplained residue; zero inventions in 124 cells; stability 96.0%. The replication graded the original in both directions: candidate anchor erratum #16 (Castro's "ileus" = the primary's PPC counts, quote on record) and **two errata of our own key** (de Waal ASA contradicting adjudicated erratum #10; Coeckelenbergh blood-loss arms, decided by the abstract's parallel sentence). H6.4 (MA-2 formal lens) pending; Paper 4 awaits it.
