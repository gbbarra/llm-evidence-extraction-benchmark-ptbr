...
| Q4 | Is a committee a mechanism or just retrospective arithmetic? | Amendment 5 (OR-27B vs MAJ-3, calc+synthesis over committee sheets) | **running** | detection table done (union 10/10 @15.3% FA; majority 7/10 @3.5%); diamonds pending |
...
| Q6 | Who is the best tool calculator, fairly compared? | Amendment 6: calculator championship — 4 veterans × 2 lanes under v3, identical audited sheets | **registered, queued after Q4** | — |
| Q7 | Does gemma26 audit? (last empty cell of the 4×matrix) | proposed, unregistered | **awaiting author's call** | — |
