...
| Sujatha et al. (PMC6907038) | tempo=comparable (except PVI vs control p=0.046); tempo=comparable (except PVI vs control p=0.046) | insufficient-data | MD -5.0 [-12.1, 2.1] | insufficient · fonte-indisponivel [dado-fora-do-insumo] · The days to ICU stay, HDU stay, return of bowel movement, days to oral intake … are given in Table 4 |
