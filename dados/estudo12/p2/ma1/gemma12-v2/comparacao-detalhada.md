...
| study | model cells (reversed) | ours | published | category |
|---|---|---|---|---|
| de Waal et al. (REF29) | mortalidade=10 (4.0%); mortalidade=10 (4.3%) | RR 1.0 [0.423, 2.362] (a=10/259, c=10/259) | RR 0.944 [0.4, 2.226] | verify (rota-do-modelo or erro-do-modelo — adjudicate in the source) |
...
**Pool (ours)**: MH {"rr": 1.095, "ic95": [0.482, 2.49]} · DL {"rr": 1.078, "ic95": [0.47, 2.471], "tau2": 0.0, "i2": 0.0} — comparison under DL (erratum-15: DL numbers, MH caption). **Published: RR 1.021 [0.446, 2.337] → differs (decompose in the rows above)**.
