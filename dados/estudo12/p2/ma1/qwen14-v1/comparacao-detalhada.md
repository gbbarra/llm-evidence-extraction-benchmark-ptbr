...
| study | model cells (reversed) | ours | published | category |
|---|---|---|---|---|
| de Waal et al. (REF29) | mortalidade=10 (4.0%); mortalidade=10 (4.3%) | RR 0.944 [0.4, 2.226] (a=10/248, c=10/234) | RR 0.944 [0.4, 2.226] | reproduz |
...
**Pool (ours)**: MH {"rr": 1.039, "ic95": [0.458, 2.357]} · DL {"rr": 1.021, "ic95": [0.446, 2.337], "tau2": 0.0, "i2": 0.0} — comparison under DL (erratum-15: DL numbers, MH caption). **Published: RR 1.021 [0.446, 2.337] → REPRODUCES under DL**.
...
| Sun et al. (PMC10694978) | ileo=2 (4%); ileo=16 (32%) | RR 0.125 [0.03, 0.515] (a=2/50, c=16/50) | RR 0.13 [0.03, 0.53] | verify (rota-do-modelo or erro-do-modelo — adjudicate in the source) |
...
| Sujatha et al. (PMC6907038) | tempo=NR; tempo=statistically significant but clinically insignificant difference with PVI group (p = 0.046) | insufficient-data | MD -5.0 [-12.1, 2.1] | insufficient · fonte-indisponivel [dado-fora-do-insumo] · The days to ICU stay, HDU stay, return of bowel movement, days to oral intake … are given in Table 4 |
