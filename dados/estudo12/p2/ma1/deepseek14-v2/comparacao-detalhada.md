...
**Pool (ours)**: MH {"rr": 0.862, "ic95": [0.748, 0.994]} · DL {"rr": 0.769, "ic95": [0.558, 1.061], "tau2": 0.0769, "i2": 77.1} — comparison under DL (erratum-15: DL numbers, MH caption). **Published: RR 0.778 [0.567, 1.068] → REPRODUCES under DL**.
...
| Sun et al. (PMC10694978) | mortalidade=2%; mortalidade=0% | RR 3.0 [0.125, 71.927] (a=1/50, c=0/50) [derived-from-%] | RR 3.0 [0.125, 71.927] | reproduz |
...
| Sun et al. (PMC10694978) | ileo=4%; ileo=32% | RR 0.125 [0.03, 0.515] (a=2/50, c=16/50) [derived-from-%] | RR 0.13 [0.03, 0.53] | verify (rota-do-modelo or erro-do-modelo — adjudicate in the source) |
...
| study | model cells (reversed) | ours | published | category |
|---|---|---|---|---|
| Sun et al. (PMC10694978) | tempo=28.2 hours (9.2–48.0 hours); tempo=39.4 hours (24.9–67.5 hours) | insufficient-data | MD -11.0 [-16.2, -5.8] | insufficient · difere-por-escolha-documentada-da-ancora [derivavel-conversao] · shorten time to first flatus by 11 h (P = 0.009) |
