...
| study | model cells (reversed) | ours | published | category |
|---|---|---|---|---|
| de Waal et al. (REF29) | mortalidade=10 (4.0%); mortalidade=10 (4.3%) | RR 0.113 [0.051, 0.25] (a=10/274, c=10/31) | RR 0.944 [0.4, 2.226] | verify (rota-do-modelo or erro-do-modelo — adjudicate in the source) |
...
**Pool (ours)**: MH {"rr": 0.191, "ic95": [0.096, 0.379]} · DL {"rr": 0.4, "ic95": [0.018, 9.121], "tau2": 3.9761, "i2": 74.0} — comparison under DL (erratum-15: DL numbers, MH caption). **Published: RR 1.021 [0.446, 2.337] → differs (decompose in the rows above)**.
