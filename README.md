...
- **[Study 3 protocol](dados/estudo3/protocolo-estudo3.md)** — pre-registered 2026-08-29: the chained pipeline (extract → cross-model audit → tool arithmetic → synthesis → forest plot) over a low-carbohydrate-diet anchor, with sealed seeded errors and a propagation ledger; [evaluation](dados/estudo3/avaliacao-estudo3.md) · [question ledger](dados/estudo3/agenda-bracos.md).
- **[Study 4 protocol](dados/estudo4/protocolo-estudo4.md)** — pre-registered 2026-08-30: extraction plus a fully deterministic harness, five extractors from zero; [round-2 evaluation](dados/estudo4/rodada2/avaliacao-rodada2.md) · [sheets side by side](dados/estudo4/rodada2/fichas-comparadas.md) · [the arithmetic shown](dados/estudo4/rodada2/contas-comparadas.md).
...
- **The article**: [extrai-unified.pdf](paper/extrai-unified.pdf) ([LaTeX source](paper/extrai-unified.tex)) — the single, self-contained study: the pre-registered campaign of Study 12, in which six local models re-extract three published meta-analyses (29 trials) under the perturbation reading proof and the source-verified two-layer key, with both extraction sheets as a declared arm. The earlier studies (1–11) were the instrument-development record that produced the frozen instruments; their manuscript is archived in `paper/archive/` and the earlier preprints (`paper/extrai-preprint*.pdf`) are kept only as history (the medRxiv submission of the first was withdrawn by the author).
