...
- **The article**: [extrai-unified.pdf](paper/extrai-unified.pdf) ([LaTeX source](paper/extrai-unified.tex)) — the single, self-contained study: the five-phase campaign under English instruments, the sixth reader added as a pre-registered extension arm, and the instrument-development record that produced the frozen instruments. Earlier preprints (`paper/extrai-preprint*.pdf`) are superseded by it and are kept only as history; the medRxiv submission of the first was withdrawn by the author.
