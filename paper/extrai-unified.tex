...
The factuality classification of the divergent cells (21--36 per model) found \textbf{zero invention candidates in every model}: each number each model wrote exists in, or is arithmetically derivable from, the perturbed text it read. Omissions accounted for 0 cells in \texttt{gemma4:12b} and \texttt{llama3.1:8b}, 2 in \texttt{deepseek-r1:14b}, 4 in \texttt{qwen3.5:9b} and 6 in \texttt{qwen3:14b}; the remainder were value or format divergences.
