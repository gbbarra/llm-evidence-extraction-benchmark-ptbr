...
## Study 3 — the end-to-end pipeline (REGISTERED 2026-08-29)

Protocol: [`dados/estudo3/protocolo-estudo3.md`](dados/estudo3/protocolo-estudo3.md). The question both studies leave loaded: starting from raw PDFs of a **new** anchor meta-analysis (second clinical domain, post-cutoff, open-access primaries), can the local models produce a complete, auditable **mini meta-analysis** — text to forest plot — in one mini-PC night? And where does error propagate when the stages chain?
